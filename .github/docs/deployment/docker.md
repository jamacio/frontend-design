...
Success looks like:
- `frontend-design` container is listed
...
## Step 5: Open Frontend Design in Your Browser

Open:
- `http://localhost:7456/`

You should see the Frontend Design interface.

![Frontend Design home (desktop)](../screenshots/deployment/docker/01-frontend-design-home.png)
![Frontend Design home (mobile)](../screenshots/deployment/docker/03-frontend-design-mobile.png)
