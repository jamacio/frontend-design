...
- [NewAutomationModal.context-picker.test.tsx](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/apps/web/tests/components/NewAutomationModal.context-picker.test.tsx)
  覆盖创建弹窗里的 prompt/context picker。
- [router-marketplace.test.ts](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/apps/web/tests/router-marketplace.test.ts)
  覆盖 `/automations` 路由解析。
