...
本文只统计当前仓库 `frontend-design-amr-runtime-acp` 里已经落地并可执行的自动化，不包含钱包、Stripe 或其他仓库页面。

## 当前已覆盖

### 1. 组件 / 单测

#### [TasksView.page.test.tsx](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/apps/web/tests/components/TasksView.page.test.tsx)
...
#### [TasksView.history.test.tsx](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/apps/web/tests/components/TasksView.history.test.tsx)
...
#### [TasksView.templates.test.tsx](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/apps/web/tests/components/TasksView.templates.test.tsx)
...
- [RoutinesSection.test.tsx](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/apps/web/tests/components/RoutinesSection.test.tsx)
...
#### [automations-page.test.ts](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/e2e/ui/automations-page.test.ts)
...
#### [settings-memory-routines.test.ts](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/e2e/ui/settings-memory-routines.test.ts)
...
#### [routines.ts](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/e2e/lib/vitest/routines.ts)
...
#### [automations-routines.test.ts](/Users/mac/frontend-design/frontend-design-amr-runtime-acp/e2e/tests/tools-dev/automations-routines.test.ts)
...
```bash
cd /Users/mac/frontend-design/frontend-design-amr-runtime-acp
