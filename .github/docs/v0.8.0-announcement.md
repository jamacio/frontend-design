# 🔥 Frontend Design 0.8.0-preview — Design's old world ends here. Help us build the new one.

> **Status:** Now landed on `main` · 0.8.0 release tag coming up · feedback still wanted
> **Branch:** [`main`] — everything below tracks `main`
...
- **🌐 Headless by default.** The desktop app is a thin wrapper around the CLI. The same engine runs in code agent, OpenClaw, Hermes Agent, or straight inside a Lark / Discord / Slack chat. **You can drive it with code agent. code agent can be driven by it.** Design stops being a place you go and becomes a capability your agents have.
...
- 🍎 macOS (Apple Silicon): [frontend-design-0.8.0-preview.2-mac-arm64.dmg](#)
- 🍎 macOS (Intel): [frontend-design-0.8.0-preview.2-mac-x64.dmg](#)
- 🪟 Windows: [frontend-design-0.8.0-preview.2-win-x64-setup.exe](#)
- 🐧 Linux: *coming soon*
...
2. **Headless.** If you've poked at it via CLI, code agent, OpenClaw, Hermes Agent, or a Lark/Discord agent — how did that feel? Where did the magic break?
...
→ [**Join the Frontend Design preview Discord**](#)
