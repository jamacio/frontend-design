# Self-hosting An Frontend Design Registry

An Frontend Design registry is a source of `frontend-design-marketplace.json` plus the
...
```text
plugins/registry/
  official/frontend-design-marketplace.json
  community/frontend-design-marketplace.json
...
```bash
od marketplace add https://example.com/frontend-design-marketplace.json --trust restricted
...
od marketplace add https://raw.github.example.com/org/plugin-registry/main/frontend-design-marketplace.json --trust trusted
```
