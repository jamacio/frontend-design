...
### 9-section DESIGN.md format (per [awesome-AI assistant-design])
...
This format is not ours. We adopt it because awesome-AI assistant-design has already shipped 68 of them — immediate ecosystem compatibility.
...
### Failure modes
- Screenshot upload but active agent has no vision (e.g. older code agent) → suggest switching agent or fall back to "describe the screenshot in text."
