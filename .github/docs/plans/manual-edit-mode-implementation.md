...
Implementation branch: `code agent/manual-edit-mode`.

## Goal

Migrate the accepted manual edit-mode prototype into the production Frontend Design web app.
...
```bash
pnpm --filter @frontend-design/web typecheck
pnpm --filter @frontend-design/web test
pnpm --filter @frontend-design/e2e test:ui -- --grep "manual edit"
pnpm typecheck
pnpm test
