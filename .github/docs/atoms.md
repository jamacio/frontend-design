...
> The atomic capabilities Frontend Design exposes to plugins.
...
The Frontend Design daemon is responsible for resolving each atom into a system-prompt
...
2. Once the SKILL.md / tool integration / pipeline shape stabilises, append the
