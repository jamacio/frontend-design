# NotebookLM: export issues/PRs from Frontend Design

Frontend Design gets a lot of feedback via GitHub Issues + PRs. If you want NotebookLM to help with:
...
pnpm exec tsx scripts/notebooklm-export-github.ts \
  --repo nexu-io/frontend-design \
  --out notebooklm/frontend-design-snapshot.md
```
