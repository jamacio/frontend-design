<h1 align="center">Frontend Design: la alternativa de código abierto a AI assistant Design</h1>

> 🔥 **Frontend Design 0.10.0 ya está aquí: el espacio de trabajo de diseño Agentic todo en uno.** Todo el oficio vive ahora en una sola ventana — pasa de una idea difusa a descubrir referencias, reunir material, editar de forma interactiva, encolar comentarios, pulir las animaciones y entregar el resultado a un editor o a un Code Agent — sin salir de la app. Con sesiones en paralelo, deja de sentirse como un asistente y empieza a sentirse como un equipo de diseño local trabajando para ti. [Descargar 0.10.0] · [Únete a la conversación]
>
> ⚡ **Frontend Design AMR (Agentic Model Router) — el servicio de modelos oficial.** Una sola recarga para usar AI, AI assistant, AI assistant y AI model dentro de Frontend Design: más de 20 modelos insignia, cero configuración, facturación por uso real de tokens. [Probar AMR](#)
>
> 🏅 **El programa Frontend Design Fellow ya está abierto.** Si tú también crees que el diseño debe ser abierto, conviértete en Frontend Design Fellow, da forma al producto junto al equipo principal y ayuda a que más personas participen en definir el futuro del diseño. Detalles → [`MAINTAINERS.md`](../../MAINTAINERS.md) y [Discord](#).
...
<td width="50%" valign="top">
<sub><b>Integrations</b> — conecta sistemas externos y herramientas MCP, y usa Frontend Design desde cualquier IDE, script o automatización.</sub>
</td>
</tr>
</table>
...
> Frontend Design se distribuye como **skills, una CLI y un servidor MCP** que los agentes de codificación más populares consumen de forma nativa. Una vez instalado OD, un único `od mcp install <agent>` conecta el servidor MCP a la configuración de ese agente, y AI models a las mismas herramientas desde dentro de cualquier agente.

| Agente de codificación / plataforma &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; | Estado &nbsp;&nbsp; | Instalación del servidor MCP en una línea &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; |
|---|:---:|---|
| [code agent](design documentation assistant-code) | ✅ Compatible | `od mcp install AI assistant` |
| [code agent CLI] | ✅ Compatible | `od mcp install code agent` |
| [code editor](# editor.com/cli) | ✅ Compatible | `od mcp install code editor` |
| [VS Code + GitHub AI assistant] | ✅ Compatible | `od mcp install AI assistant` |
| [GitHub AI assistant CLI] | ✅ Compatible | `od mcp install AI assistant` |
| [AI assistant CLI] | ✅ Compatible | `od mcp install AI assistant` |
| [OpenCode](#) | ✅ Compatible | `od mcp install opencode` |
| [OpenClaw] | ✅ Compatible | `od mcp install openclaw` |
| [Antigravity](https://#) | ✅ Compatible | `od mcp install antigravity` |
| [Cline] | ✅ Compatible | `od mcp install cline` |
| [Trae](https://#/) | ✅ Compatible | `od mcp install trae` |
| [Kimi CLI] | ✅ Compatible | `od mcp install kimi` |
| [Pi Agent] | ✅ Compatible | `od mcp install pi` |
| [AI provider Vibe CLI] | ✅ Compatible | `od mcp install vibe` |
...
**¿No tienes una CLI instalada?** El proxy BYOK en `POST /api/proxy/{AI,AI provider,azure,google,oAI model,senseaudio}/stream` te da el mismo bucle (sin crear procesos): pega `baseUrl` + `apiKey` + `model`, con soporte para AI provider, AI, Azure AI provider, cloud AI assistant, OAI model, LM Studio, vLLM o cualquier endpoint compatible con AI provider. La protección SSRF por destino bloquea IPs internas / link-local / CGNAT en el borde del daemon.
...
<sub><b>Prototipo de app móvil</b> — un flujo gamificado de tres pantallas con cintas de XP y detalle de misiones. Entrégalo directamente a code editor / code agent / code agent para convertirlo en React/Next/Vue.</sub>
</td>
</tr>
</table>
...
<sub><b>Modo presentación (guizang-ppt)</b> — diseños tipo revista, hero WebGL, checklists P0/P1/P2. Empaquetado textualmente desde <a href=" con su licencia original preservada.</sub>
</td>
<td width="50%" valign="top">
...
### 4 · Imágenes — `AI-image-2`, ImageRouter, API personalizada

<table>
<tr>
<td width="20%" valign="top"><img src="#" alt="Mapa gastronómico ilustrado de una ciudad" /><br/><sub><b>Mapa gastronómico ilustrado de una ciudad</b><br/>Póster de viaje editorial dibujado a mano</sub></td>
<td width="20%" valign="top"><img src="#" alt="Escena cinematográfica de ascensor" /><br/><sub><b>Escena cinematográfica de ascensor</b><br/>Toma editorial de un solo fotograma</sub></td>
<td width="20%" valign="top"><img src="#" alt="Retrato anime cyberpunk" /><br/><sub><b>Retrato cyberpunk</b><br/>Avatar de perfil — rostro con texto de neón</sub></td>
<td width="20%" valign="top"><img src="#" alt="Evolución de escalera de piedra 3D" /><br/><sub><b>Escalera de piedra 3D</b><br/>Infografía de piedra tallada</sub></td>
<td width="20%" valign="top"><img src="#" alt="Retrato glamuroso" /><br/><sub><b>Retrato glamuroso</b><br/>Toma editorial de estudio</sub></td>
</tr>
</table>
...
**[HyperFrames][hyperframes]** es el framework de video de código abierto y agent-native de HeyGen, integrado como ciudadano de primera clase en Frontend Design. El agente escribe HTML + CSS + GSAP, y HyperFrames lo renderiza a un MP4 determinista mediante Chrome headless + FFmpeg. Combínalo con **Seedance 2.0** para t2v / i2v cinematográfico, **Veo 3 / Sora 2 / Kling 2** para variantes de modelo enrutadas, y **Suno v5 / Lyria 2** para la capa de audio.

<table>
<tr>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-saas-product-promo-30s.json"><img src="#" alt="Promo SaaS" /></a><br/><sub><b>Promo de producto SaaS de 30s</b> · 16:9 · revelaciones 3D de UI</sub></td>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-tiktok-karaoke-talking-head.json"><img src="#" alt="Karaoke de TikTok" /></a><br/><sub><b>Talking-head de karaoke para TikTok</b> · 9:16 · TTS + subtítulos sincronizados por palabra</sub></td>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-brand-sizzle-reel.json"><img src="#" alt="Sizzle reel de marca" /></a><br/><sub><b>Sizzle reel de marca de 30s</b> · 16:9 · tipografía cinética reactiva al audio</sub></td>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-data-bar-chart-race.json"><img src="#" alt="Carrera de gráfico de barras" /></a><br/><sub><b>Carrera de gráfico de barras</b> · 16:9 · infografía de datos estilo NYT</sub></td>
</tr>
<tr>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-flight-map-route.json"><img src="#" alt="Mapa de vuelo" /></a><br/><sub><b>Mapa de vuelo</b> · 16:9 · revelación de ruta estilo Apple</sub></td>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-logo-outro-cinematic.json"><img src="#" alt="Outro de logo" /></a><br/><sub><b>Outro de logo cinematográfico de 4s</b> · 16:9 · ensamblaje pieza a pieza + bloom</sub></td>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-money-counter-hype.json"><img src="#" alt="Contador de dinero" /></a><br/><sub><b>Contador de dinero $0 → $10K</b> · 9:16 · hype estilo Apple</sub></td>
<td width="25%" valign="top"><a href="../../prompt-templates/video/hyperframes-website-to-video-promo.json"><img src="#" alt="Sitio web a video" /></a><br/><sub><b>Sitio web a video</b> · 16:9 · captura el sitio en 3 viewports</sub></td>
</tr>
</table>
...
## Por qué Frontend Design

> **En abril de 2026, AI lanzó [AI assistant Design][cd] — la primera vez que un LLM dejó de escribir prosa y empezó a entregar artefactos de diseño directamente.** Se volvió viral. Pero permaneció de código cerrado, solo de pago, solo en la nube, atado al modelo de AI, a los skills de AI, a la superficie de AI. Sin checkout, sin self-host, sin despliegue en Vercel, sin posibilidad de cambiar a tu propio agente.

Frontend Design (OD) es la alternativa de código abierto. El mismo bucle, el mismo modelo mental centrado en el artefacto, sin nada del lock-in:

- 🤖 **Agent-native, agnóstico al modelo.** No distribuimos un agente. Los `AI assistant` / `code agent` / `code editor-agent` / `AI assistant` / `hermes` / `kimi` que ya están en tu `PATH` son el motor de diseño. Cámbialos con un clic.
- 🧠 **Calidad de marca por defecto.** Cada render lee el `DESIGN.md` activo — un esquema de 9 secciones que cubre paleta, tipografía, espaciado, movimiento, voz y antipatrones. 150 sistemas se incluyen en el repo (Linear, Stripe, Vercel, Airbnb, Apple, Tesla, Notion, AI, code editor, Supabase, Figma…). Suelta una carpeta y el selector la encuentra.
...
| Agent-native (se ejecuta en tu CLI) | Solo AI | ❌ | Solo agente en la nube | **✅ 21 CLIs + BYOK** |
...
La forma más rápida de usar Frontend Design. Sin Node, sin pnpm, sin clonar.

- **macOS** (Apple Silicon · Intel x64) → [**#**](#) o [GitHub Releases]
- **Windows** (x64) → [**#**](#) o [GitHub Releases]
- **Linux** (AppImage, vía opcional) → [GitHub Releases]
...
Puedes usar Frontend Design sin abrir nunca la GUI — llámalo como skill, plugin o servidor MCP dentro de code agent, code agent, code editor, AI assistant, OpenClaw, Antigravity, Hermes, Kimi y más.
...
4. **Entrega a ingeniería.** El artefacto es HTML/CSS real — suéltalo en code editor, code agent o code agent para seguir construyendo como código. O exporta PPTX / PDF / MP4 directamente a marketing.
5. **Frontend Design se vuelve más inteligente conforme lo usas.** Tus capturas, fuentes, paletas y artefactos confirmados se acumulan como valores por defecto para la próxima sesión. Menos retrabajo, menos deriva.

---

## Usa Frontend Design desde tu agente de codificación

Frontend Design distribuye un **servidor MCP por stdio** y **scripts de instalación** por agente. Cualquier agente compatible con MCP en otro repo puede leer archivos de tus proyectos locales de Frontend Design directamente — tokens CSS, componentes JSX, HTML de entrada — como una API estructurada consultable por nombre. El agente siempre ve el archivo en vivo, no una exportación obsoleta.
...
**Para un agente que empieza desde cero,** el instalador coloca `~/.config/<agent>/frontend-design.json` (o el equivalente de la plataforma) más un fragmento MCP para copiar y pegar. code editor obtiene un deeplink de un clic; code agent obtiene un comando `AI assistant mcp add-json` de una línea; cada otro agente obtiene JSON en el esquema que su configuración espera. Flujo completo por agente → **Settings → tool server** en la app de escritorio, o [`docs/agent-adapters.md`](../../docs/agent-adapters.md).
...
**Más de 100 skills vienen incluidos** — cada uno es una carpeta bajo [`skills/`](../../skills/) que sigue la convención [`SKILL.md`][skill] de code agent, extendida con un frontmatter `od:` (`mode`, `platform`, `scenario`, `preview.type`, `design_system.requires`, `default_for`, `fidelity`, `example_prompt`). Suelta una carpeta, reinicia el daemon y aparece en el selector.
...
- 🤖 **Ejecutarse en cualquier agente de codificación** — [code agent](../../docs/agent-adapters.md), code agent, code editor, AI assistant, [OpenClaw], [Antigravity](https://#), Hermes, Kimi… a través del mismo protocolo de skills que el agente ya conoce.
...
Un plugin **necesita como mínimo solo un `SKILL.md`**; para listarlo en el marketplace de Frontend Design, añade un `frontend-design.json`:
...
1. Suelta la carpeta del plugin en [`plugins/community/`](../../plugins/community/) (plugins de terceros), o — para distribuirlo empaquetado con Frontend Design — en el nivel correspondiente de [`plugins/_official/`](../../plugins/_official/).
2. Pasa la validación: `od plugin validate`, `pnpm guard`, `pnpm --filter @frontend-design/plugin-runtime typecheck`.
...
4. Para publicar en un registro externo (# / ClawHub / GitHub independiente) → [`plugins/spec/PUBLISHING-REGISTRIES.md`](../../plugins/spec/PUBLISHING-REGISTRIES.md).
...
- [x] Proxy BYOK multiproveedor (`/api/proxy/{AI,AI provider,azure,google,oAI model,senseaudio}/stream`) + protección SSRF
- [x] Importación de ZIP de AI assistant Design (`/api/import/AI assistant-design`)
...
- [x] **0.9.0** — Frontend Design AMR (Model Router oficial integrado en la app: cero configuración, inicio de sesión de un clic)
...
- 💬 **Discord** — chat diario, intercambio de plugins, preguntas → [**#**](#)
...
Frontend Design sigue avanzando porque los colaboradores — diseñadores, ingenieros, autores de prompts — siguen apareciendo. Muchos de los skills, sistemas de diseño y plugins más usados fueron escritos por personas ajenas al equipo principal.
...
| Un nuevo **plugin** | Suelta `frontend-design.json` + manifiesto bajo una carpeta de categoría | [`plugins/community/`](../../plugins/community/) · especificación en [`plugins/spec/SPEC.md`](../../plugins/spec/SPEC.md) · guía de desarrollo con agente en [`plugins/spec/AGENT-DEVELOPMENT.md`](../../plugins/spec/AGENT-DEVELOPMENT.md) |
...
Estamos reclutando **Frontend Design Fellows** en todo el mundo — los Fellows dan forma al producto junto al equipo principal, representan oficialmente a Frontend Design en su región y hacen crecer la comunidad localmente, respaldados por apoyo financiado ($1,000 / MR), créditos LLM gratuitos y una vía de revisión directa. Detalles → [`MAINTAINERS.md`](../../MAINTAINERS.md) y el anuncio en [Discord](#).
...
El SVG de arriba se regenera diariamente mediante [`.github/workflows/metrics.yml`](../../.github/workflows/metrics.yml) usando [`lowlighter/metrics`].
...
| Proyecto | Rol |
|---|---|
| [AI assistant Design][cd] | El producto de código cerrado del que este repo es la alternativa de código abierto. |
| [`#/huashu-design`] | La brújula de la filosofía de diseño — flujo de trabajo de diseñador junior, protocolo de recursos de marca, checklist anti-AI-slop, crítica de cinco dimensiones. |
| [`#/guizang-ppt-skill`] | El skill de PPT web estilo revista, empaquetado textualmente bajo [`design-templates/guizang-ppt/`](../../design-templates/guizang-ppt/). Por defecto para el modo presentación. |
...
| [`OpenCoworkAI/open-codesign`] | La primera alternativa de código abierto a AI assistant Design; patrones de UX que tomamos prestados (bucle de artefacto en streaming, iframe en entorno aislado, panel de agente en vivo). |
| [`#/multica`] | La arquitectura de daemon + adaptador — detección de agentes por escaneo del PATH, daemon local como único proceso privilegiado. |
...
| hyperframes HTML→MP4 framework | El framework de gráficos en movimiento HTML→MP4, integrado como el `hyperframes-html` de primera clase en Frontend Design. |
| [code agent skills][skill] | La convención `SKILL.md` que adoptamos textualmente. |
...
Apache-2.0. El `design-templates/guizang-ppt/` incluido conserva su [LICENSE](../../design-templates/guizang-ppt/LICENSE) original (MIT, [@#]). El `design-templates/html-ppt/` incluido conserva su [LICENSE](../../design-templates/html-ppt/LICENSE) original (MIT, [@lewislulu]).
