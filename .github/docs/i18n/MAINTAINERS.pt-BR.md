...
Maintainer de `nexu-io/frontend-design`. A composição individual do Core Team é
...
| **Core Team** | Time interno do Frontend Design. Possui acesso total de escrita ao repositório e é a autoridade final em decisões de governança. Composição mantida internamente. |
...
- **≥ 20 merged PRs** em `nexu-io/frontend-design`.
...
Enquanto `nexu-io/frontend-design` tiver menos de seis meses desde o commit inicial,
