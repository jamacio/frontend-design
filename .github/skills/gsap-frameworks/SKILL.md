...
> Curated from GreenSock's official GSAP skills: 
...
For a runnable Vite + Vue 3 project demonstrating these patterns, see the upstream example at 
...
> For a runnable Nuxt 4 project with plugin registration, lazy loading, and SSR-safe patterns, see 
