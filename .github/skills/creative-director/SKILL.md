...
## Frontend Design orchestration mode

When this skill is invoked inside Frontend Design, treat it as the design-flow
...
3. Search across every available Frontend Design resource, not only this skill:
   skills, plugins, tool servers and templates, connected connectors, design
