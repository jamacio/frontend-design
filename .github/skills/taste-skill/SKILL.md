...
* **NO custom mouse code editors.** Outdated, accessibility-hostile, perf-hostile.
...
* **NO broken Unsplash links.** Use `#`, or generated photo placeholders, or actual assets.
...
* **Magnetic Button** - Pulls toward code editor.
...
* **Spotlight Border Card** - Borders illuminate under code editor.
...
* **Kinetic Typography Grid** - Letters dodging the code editor.
...
* **Directional Hover-Aware Button** - Fill enters from code editor's exact side.
...
* Realtime collab UIs (presence, code editors, OT-aware - different problem class).
