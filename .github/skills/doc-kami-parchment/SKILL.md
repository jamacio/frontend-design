...
example_desc: "一页 Frontend Design Studio Issue №26 编辑级 one-pager"
example_source_url: "
example_source_label: "#/kami"
od:
  mode: prototype
  surface: web
  platform: desktop
...
【模板: Kami 羊皮纸文档】
【意图】严肃排版文档: one-pager / 长报告 / 信函 / 简历 / 财报 / changelog / portfolio。Inspired by #/kami。强调"写得像被排过版的纸", 不是 dashboard, 不是网页。
