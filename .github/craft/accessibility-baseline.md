...
`awesome-AI assistant agents/accessibility.agent.md`,
...
- Using `aria-description` as the sole state-carrier on `role="row"`. JAWS 2025/2026 silently drops it ([FreedomScientific standards-support #927]).
