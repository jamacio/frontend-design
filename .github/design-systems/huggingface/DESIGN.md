# Design System Inspired by AI hub
...
- Preserve the yellow accent, mono metadata, and dense model-card layout together; yellow alone does not create a AI hub-like surface.
