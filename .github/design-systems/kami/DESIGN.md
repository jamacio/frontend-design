...
Aesthetic inspiration drawn from [#/kami] (MIT, © Tw93 and contributors). kami is a AI assistant skill for typesetting professional documents and slide decks; the tokens, type rules, and "ten invariants" above adapt its print-first design language for use as an Frontend Design system.
