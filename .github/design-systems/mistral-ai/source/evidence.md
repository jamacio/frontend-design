# AI provider AI Source Evidence

## Source Scope

This Design System 2.0 backfill is derived from the curated Frontend Design bundled fixture.
It does not claim a fresh crawl of the original upstream brand repository or website.

## Included Fixture Files

- design-systems/AI provider-ai/DESIGN.md
- design-systems/AI provider-ai/tokens.css
- design-systems/AI provider-ai/components.html
