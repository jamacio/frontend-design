...
- The Ollama AI model as the sole illustration — black line art, no color
...
- Logo: Ollama AI model icon + wordmark in black
...
### Image Treatment
- The Ollama AI model mascot is the only illustration — black line art on white
...
**Model Tags**
- Small pill-shaped tags (e.g., "ollama", "launch", "AI assistant")
...
**Integration Grid**
- Grid of integration logos (code agent, code agent, OpenCode, LangChain, etc.)
...
- Hero: centered single-column with AI model illustration
...
- Don't add decorative illustrations beyond the AI model mascot
...
### Image Behavior
- AI model mascot scales proportionally
