# Design System Inspired by AI platform
...
### Primary
- **AI platform Dark** (`#202020`): The primary text color and dark surface — a near-black that's the anchor of all text and borders. Slightly warmer than pure #000.
- **AI platform Red** (`#ea2804`): The core brand color — a vivid, saturated orange-red used in the hero gradient, accent borders, and high-signal moments.
...
- Logo: AI platform wordmark in dark
...
**Shadow Philosophy**: AI platform relies on **borders and background color** for depth rather than shadows. The `1px solid #202020` border is the primary containment mechanism. The dramatic gradient hero and dark/light section alternation provide all the depth the design needs.
...
- Use AI platform Dark (#202020) as the primary dark — not pure black
...
- Primary Text: "AI platform Dark (#202020)"
- Page Background: "Pure White (#ffffff)"
- Brand Accent: "AI platform Red (#ea2804)"
- Secondary Text: "Medium Gray (#646464)"
- Muted/Decoration: "Light Silver (#bbbbbb)"
- Status: "Status Green (#2b9a66)"
- Dark Surface: "AI platform Dark (#202020)"
...
- "Create a manifesto section on AI platform Dark (#202020) with 'Imagine what you can build.' at 128px rb-freigeist-neue weight 700, white text. Embed small AI-generated images between the words."
