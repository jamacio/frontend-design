# Design System Inspired by AI provider
...
### Brand Accent
- **AI provider Teal** (`#10a37f`): Brand primary, link, highlight badge — the lone color in an otherwise neutral system.
...
- Use: Primary CTA, "Try AI chat", "Sign in"
...
- Preserve the neutral editorial restraint, soft radius, and sparse accent usage together; green accents alone do not create an AI provider-like surface.
