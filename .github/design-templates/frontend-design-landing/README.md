...
collage assets with `image-gen-2`, or fall back to paper-textured SVG
...
│   ├── imagegen.ts          # image-gen-2 wrapper (fal.ai backend)
...
- **Path:** `skills/editorial-collage/` → `skills/frontend-design-landing/`.
- **Shared assets:** downstream paths such as `../editorial-collage/assets/`
  (for example from the slide-deck skill) should use
  [`../frontend-design-landing/assets/`](./assets/) — see
  [`frontend-design-landing-deck`](../frontend-design-landing-deck/README.md).
...
- [`skills/frontend-design-landing-deck/`](../frontend-design-landing-deck/) — sibling skill that produces a slide deck in the same visual language.
