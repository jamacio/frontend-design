...
Sister skill to [`frontend-design-landing`](../frontend-design-landing/).
...
The deck assumes 16 collage assets at `../frontend-design-landing/assets/`
...
uses `'../frontend-design-landing/assets/'`.

To regenerate or stub:

```bash
# Generate via image-gen-2 (fal.ai)
FAL_KEY=fal-... npx tsx ../frontend-design-landing/scripts/imagegen.ts \
  ../frontend-design-landing/inputs.example.json \
  --out=../frontend-design-landing/assets/
...
| Old | New |
| --- | --- |
| skill folder `editorial-collage-deck/` | `frontend-design-landing-deck/` |
| shared assets `../editorial-collage/assets/` | `../frontend-design-landing/assets/` |
| TS type `EditorialCollageDeckInputs` | `FrontendDesignLandingDeckInputs` |
