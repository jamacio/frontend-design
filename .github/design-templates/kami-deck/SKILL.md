...
[`frontend-design-landing-deck/scripts/compose.ts`](../frontend-design-landing-deck/scripts/compose.ts).
Do **not** reuse the frontend-design-landing-deck CSS; the visual
...
- **Do not** reuse Atelier Zero collage imagery (the frontend-design-landing
...
- [`frontend-design-landing-deck`](../frontend-design-landing-deck/) — same
  horizontal swipe nav model, different visual language (Atelier Zero).
- Upstream: #/kami original skill (MIT). Kami's slides.py template documents the macro × 1.6 / micro × 0.6 ratios this skill applies.
