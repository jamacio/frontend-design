...
To preview the canonical Frontend Design instance:
...
1. Open the skill in your agent (AI assistant · code editor · code agent · …).
...
└── example.html  # canonical Frontend Design rendering (9 slides)
```
...
- Upstream: #/kami original skill (MIT) the design system adapts.
