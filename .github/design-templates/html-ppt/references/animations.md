...
| `typewriter-multi` | 3 lines typing concurrently with blinking block code editors (DOM). | Terminal, agent boot log. | `<div data-fx="typewriter-multi" data-fx-line1="> boot...">` |
