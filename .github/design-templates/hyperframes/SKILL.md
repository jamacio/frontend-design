...
## Frontend Design integration (load-bearing for this surface)

When this skill runs inside Frontend Design (i.e. `$OD_PROJECT_DIR` is set), the
...
#    unsandboxed process. (Many agent CLIs, code agent in particular,
